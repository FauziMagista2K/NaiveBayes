                    ...
                    <div class="contact--thumbnail">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($db,"SELECT kode_gejala, nama_gejala FROM tb_gejala WHERE kode_gejala IN ('".implode("','", $selected)."')");
                ...
                <form action="" method="post">
                    <div class="contact--thumbnail">
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <?php 
                            $rows = mysqli_query($db,"SELECT * FROM tb_penyakit GROUP BY nama_penyakit");
                            foreach($rows as $row){
                            ...
                            <tr>
                                ...
                                <td rowspan="<?=count($val)?>"><?=$penyakit[$key]['nilai']?></td>        
