    ...
    <section class="hero-area">
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post bg-overlay">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(assets/alazea-gh-pages/img/bg-img/bg14.jpg);"></div>
                <div class="container h-100">
                    <div class="row h-50 align-items-center">
                        <div class="col-12">
                            <!-- Post Content -->
                            <div class="hero-slides-content text-center">
                                <h2 style="padding-top:150px">SISTEM PAKAR DIAGNOSA AWAL GANGGUAN BIPOLAR</h2>
                                <p>
                               
                            <?php
                            include 'koneksi.php';
                            $sql = mysqli_query($db,"SELECT * FROM tb_dashboard");
                            foreach ($sql as $data) {
                                echo $data['nama_dashboard'];
