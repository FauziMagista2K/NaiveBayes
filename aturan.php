            ...
            <h2>Gejala Bipolar</h2>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th style="width: 5%;">Kode Aturan</th>
                                    <th style="width: 10%;">Nama Penyakit</th>
                                    <th style="width: 10%;">Gejala Penyakit</th>
                        ...
                        $sql = "SELECT * FROM tb_aturan tb_aturan JOIN tb_penyakit ON tb_aturan.kode_penyakit = tb_penyakit.kode_penyakit JOIN tb_gejala ON tb_gejala.kode_gejala = tb_gejala.kode_gejala";
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            <tr>
                                <td><?= $nomor ?></td>									        
                                <td><?= $data['kode_aturan'] ?> </td>
                                <td><?= $data['kode_penyakit'] ?> </td>
                                <td><?= $data['kode_gejala'] ?> </td>                          
                                <td><?= $data['nilai'] ?> </td>
                                <td>
                                    <a href="edit_aturan.php?kode_aturan=<?= $data['kode_aturan'] ?>" class="btn btn-primary btn-xs">
                                        <span class="fa fa-pencil"> Edit </span>
                                    </a>
                                    <a href="delete_aturan.php?kode_aturan=<?= $data['kode_aturan'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda Ingin Menghapus User?')">
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal_Add" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="add_aturan.php">
                <div class="modal-body">
                <div class="form-group row">
                        <label class="col-sm-4 control-label">Kode Aturan</label>
                        <div class="col-sm-8">
                            <textarea name="kode_aturan" required class="form-control" rows="3"></textarea>
                        </div>
                        <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <select name="kode_penyakit" id="kode_penyakit" class="form-control" required>
                            <option disabled selected>Pilih Data Penyakit</option>
                            <?php
                                include 'koneksi.php';
                                $sql = mysqli_query($db,"SELECT * FROM tb_penyakit");
                    ...
                    <div class="form-group row">
                        ...
                        <select name="kode_gejala" id="kode_gejala" class="form-control" required>
                            <option disabled selected>Pilih Data gejala</option>
                            <?php
                                include 'koneksi.php';
                                $sql = mysqli_query($db,"SELECT * FROM tb_gejala");
                                while($data= mysqli_fetch_assoc($sql)) :
                            ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="nilai" required class="form-control" rows="3"></textarea>
                        </div>
                    </div>
