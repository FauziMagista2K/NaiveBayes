                    ...
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="top-header-meta d-flex">
                             ...
                             <div class="classynav">
                                <ul>
                                    <li><a href="index_us.php">Dashboard</a></li>
                                    <li><a href="info_us.php">Info Bipolar Disorder</a></li>
                                    <li><a href="gejala_us.php">Gejala</a></li>
                                    <li><a href="tipeuser_bipolar.php">Tipe Bipolar</a></li>
                                    <li><a href="konsultasi_us.php">Konsultasi</a></li>
                                    </ul>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal_Add" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="add_gejala.php">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">Kode Gejala</label>
                        <div class="col-sm-8">
                            <input type="type" required autocomplete="off" class="form-control"  name="kode_gejala" placeholder="" >
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">Nama Gejala</label>
                        <div class="col-sm-8">
                            <textarea name="nama_gejala" required class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
