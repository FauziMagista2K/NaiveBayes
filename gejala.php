                    ...
                    <div class="card-body">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            <tr>
                                ...
                                <td><?= $data['nilai'] ?> </td>
                                <td>
                                    <a href="edit_gejala.php?kode_gejala=<?= $data['kode_gejala'] ?>" class="btn btn-primary btn-xs">
                                        <span class="fa fa-pencil"> Edit </span>
                                    </a>
                                    <a href="delete_gejala.php?kode_gejala=<?= $data['kode_gejala'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda Ingin Menghapus User?')">
