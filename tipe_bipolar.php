                    ...
                    <div class="card-body">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            <tr>
                                ...
                                <td><?= $data['nilai'] ?> </td>
                                <td>
                                    <a href="edit_penyakit.php?kode_penyakit=<?= $data['kode_penyakit'] ?>" class="btn btn-primary btn-xs">
                                        <span class="fa fa-pencil"> Edit </span>
                                    </a>
                                    <a href="delete_penyakit.php?kode_penyakit=<?= $data['kode_penyakit'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda Ingin Menghapus User?')">
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal_Add" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="add_penyakit.php">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">Kode Penyakit</label>
                        <div class="col-sm-8">
                            <input type="type" required autocomplete="off" class="form-control"  name="kode_penyakit" placeholder="" >
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-4 control-label">Nama Penyakit</label>
                        <div class="col-sm-8">
                            <textarea name="nama_penyakit" required class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
