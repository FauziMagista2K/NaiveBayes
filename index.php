...
<body>
    ...
    <div class="breadcrumb-area">
        <!-- Top Breadcrumb Area -->
        <div class="top-breadcrumb-area bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(assets/alazea-gh-pages/img/bg-img/bg14.jpg);">
            <h2>Sistem Pakar Diagnosa Bipolar</h2>
        </div>
                <div class="card">
                    <div class="card-header">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th style="text-align: center; width: 5%;">Isi Dashboard</th>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                               //Penambahan satu untuk nilai var nomor
                                ?>              
                                <tr>                    
                                    <td><?= $data['nama_dashboard'] ?> </td>
                                    <td>
                                       <center> <a href="edit_dashboard.php?kode_dashboard=<?=$data['kode_dashboard'] ?>" class="badge badge-warning">Edit Isi Dashboard</a>
                                    </td>
                                </tr>
